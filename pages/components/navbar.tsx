      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`will-change-[opacity] z-[29] overflow-auto flex lg:hidden w-[280px] fixed bg-white bottom-0 top-0 right-0 h-[100vh] max-h-[100%] drop-shadow-md flex-col justify-start items-center pt-[80px]`}
          >
