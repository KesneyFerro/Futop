...
const Home: NextPage = ({ posts }: any) => {
  ...
  return (
    <HomeCointainer>
      ...
      <main className="flex items-center flex-col dark:bg-[#161819]">
        <Navbar />
        <div className="mainContentOpportunities w-[90%] sm:w-[80%] flex justify-center flex-col mt-[80px]  mb-10">
          ...
          <div className="mt-16 searchbar bg-[#FDFDFE] dark:bg-[#1F2123] w-full mb-16 h-auto drop-shadow-md rounded-[15px] flex-col px-4">
            ...
            {isFilterOpen && (
              <div className="w-full h-14 flex items-center mb-[10.5px]">
                <select
                  ...
                  className=" border-2 mr-7 border-black/30 dark:border-white/60 text-[15px] text-black/70 font-semibold drop-shadow-sm appearance-none text-center rounded-2xl px-2 bg-white dark:bg-[#1F2123] dark:text-white/100 text-black w-full py-[10px]"
                >
                ...
                <select
                  ...
                  className=" border-2 border-black/30 dark:border-white/60 text-[15px] text-black/70 font-semibold drop-shadow-sm appearance-none text-center rounded-2xl px-2 bg-white dark:bg-[#1F2123] dark:text-white/100 text-black w-full py-[10px]"
                >
